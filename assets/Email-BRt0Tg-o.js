import{ae as e,af as r,ah as a,ai as n,aj as i}from"./index-DFQJmrz7.js";import{u as t}from"./index-DfRjW0OV.js";import"./chunk-NUUEMKO5-CLy9nqUZ.js";/* empty css             *//* empty css                    */import"./iframe-BI3XuDMF.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-D-8MO0q_.js";import"./index-DLgkWgLR.js";import"./index-DrFu-skq.js";function d(l){const s={code:"code",h1:"h1",h2:"h2",h4:"h4",p:"p",...t(),...l.components};return e.jsxs(e.Fragment,{children:[e.jsx("link",{rel:"preconnect",href:"https://fonts.googleapis.com"}),`
...
`,e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Family"}),e.jsx("th",{children:"Description"}),e.jsx("th",{children:"Weights available"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{width:"25%",children:e.jsx("div",{style:{fontFamily:"Inter",fontSize:"30px"},children:"Inter"})}),e.jsxs("td",{children:[e.jsx("a",{href:"https://fonts.google.com/specimen/Inter",target:"_blank",children:e.jsx(s.p,{children:"Inter"})})," ",e.jsx(s.p,{children:`is our only typeface for email design. It's a sans-serif webfont
provided by Google Fonts, and it's our unique typeface for headlines,
body copy, buttons, and any other component. It relies on Helvetica and
Arial as a fallback in case the font file can't be retrieved, or the
email client doesn't support webfonts.`})]}),e.jsxs("td",{width:"25%",children:[e.jsx(s.p,{children:"400 (Regular)"}),e.jsx("br",{}),e.jsx(s.p,{children:"600 (Semibold)"}),e.jsx("br",{}),e.jsx(s.p,{children:"700 (Bold)"})]})]})})]}),`
...
`,e.jsxs(a,{children:[e.jsx(n,{title:"Full Palette",colors:{Raisin:"#292525",Moonstone:"#1f96e0",White:"#ffffff",Alabaster:"#f4f2e6",Cultured:"#f8f7f3"}}),e.jsx(n,{title:"Surface",colors:{"color-surface-dark":"#292525","color-surface-light":"#ffffff","color-surface-alabaster":"#f4f2e6"}}),e.jsx(n,{title:"Text",colors:{"color-text-default":"#292525","color-text-on-dark":"#f8f7f3"}}),e.jsx(n,{title:"Decorative",colors:{"color-decorative-icon-dark":"#292525","color-decorative-icon-light":"#f8f7f3"}}),e.jsx(n,{title:"Action",colors:{"color-primary":"#1f96e0","color-secondary":"#292525","color-affiliation":"#ffffff"}})]}),`
...
`,e.jsxs("div",{children:[e.jsx("h4",{children:"Notes:"}),e.jsxs("ul",{children:[e.jsx("li",{children:e.jsx(s.p,{children:`If a token is not specified, it will inherit all properties from the
"body" token. This is the initial styling for every component.`})}),e.jsx("li",{children:e.jsxs(s.p,{children:[e.jsx("span",{class:"idsmail--label",children:"LABEL"}),` tags should always be in
uppercase characters. Although it has a rule in CSS to force it (
`,e.jsx("code",{children:"text-transform: uppercase;"}),`) it's still recommended to write
the content itself in uppercase letters too.`]})}),e.jsx("li",{children:e.jsxs(s.p,{children:[e.jsx("code",{children:".idsmail--link"})," and ",e.jsx("code",{children:".idsmail--bold"}),` are inline
styling elements, and should be used differently. This is explained later
in "MJML class names and CSS class names"`]})})]})]}),`
...
`,e.jsxs("div",{style:{backgroundColor:"#292525",padding:"30px",maxWidth:"600px"},children:[e.jsx("div",{class:"idsmail--header1",style:{color:"#f8f8f8"},children:e.jsx(s.p,{children:"Header 1"})}),e.jsx("div",{class:"idsmail--header2",style:{color:"#f8f8f8"},children:e.jsx(s.p,{children:"Header 2"})}),e.jsx("div",{class:"idsmail--header3",style:{color:"#f8f8f8",marginBottom:"20px"},children:e.jsx(s.p,{children:"Header 3"})}),e.jsx("div",{style:{color:"#f8f8f8",marginBottom:"20px"},children:e.jsx(s.p,{children:`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum
bibendum, orci vel suscipit placerat, urna nisl porttitor dolor, bibendum
elementum.`})}),e.jsx("div",{class:"idsmail--small",style:{color:"#f8f8f8"},children:e.jsx(s.p,{children:`Ut tincidunt leo aliquam arcu euismod, quis consequat leo congue. Proin id
urna id odio posuere dictum. Interdum et malesuada fames ac ante ipsum
primis in faucibus.`})})]}),`
...
`,e.jsxs("div",{style:{backgroundColor:"#292525",padding:"30px",maxWidth:"600px"},children:[e.jsx("div",{class:"idsmail--btn",style:{marginBottom:"20px"},children:e.jsx(s.p,{children:"Button Primary"})}),e.jsx("br",{}),e.jsx("div",{class:"idsmail--btn-secondary",children:"Button Secondary"})]}),`
`,e.jsx(i,{language:"html",dark:!0,code:`
...
`,e.jsxs("div",{style:{backgroundColor:"#292525",padding:"30px",maxWidth:"600px"},children:[e.jsx("img",{class:"idsmail--avatar",src:"https://this-person-does-not-exist.com/img/avatar-11842daaa027c03d164ed7be3fa0f969.jpg"}),e.jsx("div",{class:"idsmail--header4",style:{color:"#f8f8f8",paddingBottom:"0"},children:e.jsx(s.p,{children:"Adriana J."})}),e.jsx("div",{style:{color:"#f8f8f8"},children:"Marketing Specialist"})]}),`
`,e.jsx(i,{language:"html",dark:!0,code:`
...
`,e.jsxs("div",{style:{backgroundColor:"#292525",padding:"30px",maxWidth:"600px"},children:[e.jsx("div",{class:"idsmail--card-caption",children:"Project or Call"}),e.jsx("div",{class:"idsmail--card-title idsmail--link",children:"Project Name"}),e.jsx("div",{class:"idsmail--card-data",children:"for Organization Name"})]}),`
`,e.jsx(i,{language:"html",dark:!0,code:`
<mj-section>
...
<mj-text>You've been invited to join <span class="idsmail--bold">The Seven Sounds</span> organization.</mj-text>
  `}),`
`,e.jsxs(s.p,{children:["You can always find more examples and component blocks already created in our email templates, specially in the ",e.jsx(s.code,{children:"email/base-example-full.mjml"})," template."]})]})}function y(l={}){const{wrapper:s}={...t(),...l.components};return s?e.jsx(s,{...l,children:e.jsx(d,{...l})}):d(l)}export{y as default};
